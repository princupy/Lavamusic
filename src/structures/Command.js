...
const { ApplicationCommandOption, Permissions } = require('discord.js');
...
class Command {
  constructor(client, options) {
    ...
    this.permissions = {
      ...
      client: options.permissions ? options.permissions.client || [] : [Permissions.FLAGS.SEND_MESSAGES, Permissions.FLAGS.VIEW_CHANNEL, Permissions.FLAGS.EMBED_LINKS],
